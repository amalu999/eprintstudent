...
class _CustomRangeState extends State<CustomRange> {
  ...
  void confirmcOrder(subject,nameOfBook,author,beg,end,copies) {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (context) => ConfirmcOrder(subject: subject,nameOfBook: nameOfBook,author: author,beg: beg,end: end,copies: copies,rate:rate,),
    ),);
  }
  noOfCopiesDialog(){
...
//       ),
                ...
                RaisedButton(
                  ...
                  {setValues1();
                  noOfCopiesDialog();
                    //checkhere(begctrl.text, endctrl.text, copyctrl.text);
                  },
...
void checkhere(start,end,copies){
