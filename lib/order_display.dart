...
class _YourOrdersState extends State<YourOrders> with AutomaticKeepAliveClientMixin<YourOrders>{
  ...
  getMethod1() async{
    ...
    var res = await http.get(Uri.encodeFull('https://designproject---eprint.000webhostapp.com/studentorderdisplay.php?email='+email),headers: {"Accept":"application/json"});
  ...
  getMethod2() async{
    ...
    print(email);
    getValues();
    var res = await http.get(Uri.encodeFull('https://designproject---eprint.000webhostapp.com/student_page_order_display.php?email='+email),headers: {"Accept":"application/json"});
    if(res.statusCode==200){responseBody=json.decode(res.body);print(responseBody);}
    else{print("Booooom");}
    return responseBody;
            ...
            Container(
                child: FutureBuilder(
                    ...
                    builder: (BuildContext context,AsyncSnapshot snapshot){
                      ...
                      if(!(snapshot.hasData)){getMethod1();return Center(child: Text('Loading...'));}
