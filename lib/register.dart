      ...
      if(jsonDecode(res.body) == "false"){
        ...
        if(jsonDecode(res.body) == "true"){
          Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => HomeScreen(email: emailctrl.text),
          ),);
        }
                ...
                FlatButton(
                  ...
                  child: Text('SIGN IN',
                    style: GoogleFonts.varelaRound(
                      color: signin == true ? Colors.blueGrey : Colors.grey,
            ...
            MaterialButton(
                ...
                child: processing == false ? Text('Sign In',
                  style: GoogleFonts.varelaRound(fontSize: 18.0,
                      color: Colors.blueGrey),) : CircularProgressIndicator(backgroundColor: Colors.red,)
  ...
  Widget signUpUi(){
    return Column(
      children: <Widget>[
        ...
        TextField(
          controller: namectrl,
          decoration: InputDecoration(prefixIcon: Icon(Icons.accessibility,color: Colors.blueGrey,),
              hintText: 'name'),
        ),
        ...
        TextField(
            controller: phnctrl,
            decoration: InputDecoration(prefixIcon: Icon(Icons.phone,color: Colors.blueGrey,),
                hintText: 'phone'),
            keyboardType: TextInputType.phone
        ),
        TextField(
          controller: admission_noctrl,
          decoration: InputDecoration(prefixIcon: Icon(Icons.info,color: Colors.blueGrey,),
